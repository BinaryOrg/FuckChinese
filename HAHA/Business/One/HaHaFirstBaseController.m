...
//
//
//@interface HaHaFirstBaseController ()<GLYPageViewDelegate, UIScrollViewDelegate>
//
//@property (nonatomic, strong) GLYPageView *pageView;
//
//@property (nonatomic, strong) UIScrollView *scrollView;
//
//@property (nonatomic, strong) HaHaFirstController *firstVC;
//@property (nonatomic, strong) YMHLVideoFlowViewController *secondVC;
//
//@end
//
//@implementation HaHaFirstBaseController
//
//- (void)viewDidLoad {
//    [super viewDidLoad];
//
...
//}
//
//- (HaHaFirstController *)firstVC {
//    if (!_firstVC) {
//        _firstVC = [HaHaFirstController new];
