...
@interface HaHaBaseViewController ()

@property (nonatomic, strong) ASTableNode *tableNode;
@property (nonatomic, strong) HaHaRetryView *emptyView;
@property (nonatomic, strong) UIView *hlEmptyView;
@end

@implementation HaHaBaseViewController
...
- (HaHaRetryView *)emptyView {
    if (!_emptyView) {
        _emptyView = [[HaHaRetryView alloc] initWithFrame:CGRectMake(0, -TabBarHeight, ScreenWidth, ScreenHeight)];
