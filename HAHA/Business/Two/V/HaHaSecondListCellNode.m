...
@interface HaHaSecondListCellNode ()
...
@implementation HaHaSecondListCellNode
...
- (ASLayoutSpec *)layoutSpecThatFits:(ASSizeRange)constrainedSize {
    ...
    if (self.picturesNodes.count) {
        contentSpec.children = @[avatarLayout, titleAndImgSpec];
    }else {
        contentSpec.children = @[avatarLayout, self.titleNode];
    }
